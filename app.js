...
const mayaDemo={title:'Unreasonably Confident',genre:'Indie pop',voice:'Female',src:'assets/audio/maya-full.mp3',lyric:'Five K done, complained through most, / Burnt the cake but here’s my toast: / Twenty-five, still figuring it out, / Got a dog on my yoga mat and a life to laugh about.'};
...
<section class="closing"><span class="eyebrow">FOR YOU. FOR THEM. FOR THE GROUP CHAT.</span><h2>The soundtrack to your story.</h2><button class="primary" data-create="0">Start my song — $5</button></section><footer><a class="brand" href="#"><span class="brand-icon"><img src="assets/anthemsmith-mark.webp" alt=""></span><span class="brand-name">🎶 AnthemSmith🎵🔨</span></a><a class="footer-ig" href="https://www.instagram.com/anthemsmith/" target="_blank" rel="noopener">instagram.com/anthemsmith</a><span>Every song passes a quality check before delivery. Songs are AI-generated from a custom brief and lyrics. <a href="terms.html">Terms</a> · <a href="privacy.html">Privacy</a></span></footer>`;$('#soundSlot').replaceWith(builder)}
