...
const ord={order_id:data.request_id,ig_url:data.instagram1||'',category:data.category||'My Story',mood:data.mood||'',voice:data.voice||'Surprise me',details:data.details||'',email:(data.email||'').trim(),sms_to:normalizePhone(data.sms_to||''),intake:data.intake||'link',paid_status:data.paid_status||'awaiting_payment',reference_url:data.referenceUrl||''};
